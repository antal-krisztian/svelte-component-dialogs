<script>
	import { EXAMPLES_PAGE, GETTING_STARTED_PAGE, INTRODUCTION_PAGE, API_PAGE } from '../utils/pages';
</script>

<nav>
	<ul>
		<li><strong>Svelte Component Dialogs</strong></li>
	</ul>
	<ul>
		...
		<li>
			<a class="contrast" href="https://github.com/antal-krisztian/svelte-component-dialogs"
				><svg
					aria-hidden="true"
					focusable="false"
					role="img"
